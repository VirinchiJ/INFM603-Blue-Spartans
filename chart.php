    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./exlog.html">Weight and Watch</a>
        </div>
			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<li class="active"><button class ="btn btn-link"><a href="./exlog.html">Workout Log</a><span class="sr-only">(current)</span></button></li>
						<li><button class ="btn btn-link"><a  href="#">Weight Chart</a></button></li>
						<li><button class ="btn btn-link"><a href="./profile.html">Profile</a></button></li>
						<li><button class="btn btn-link"><a href="./signin.html" class="text-danger">Sign Out</a></button></li>
            		</ul>
				</div>
